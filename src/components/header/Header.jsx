...
//    change background header
    window.addEventListener("scroll", function () {
        ...
        // when the scroll is higher than 200 viewport height,add thscroll-header class to a tag with the header tag
        if(this.header >= 80) header.classList.add("scroll-header");
